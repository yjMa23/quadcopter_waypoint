...
class QuadcopterWaypointV2EnvWindow(BaseEnvWindow):
    """Window manager for the continuous waypoint v2 environment."""

    def __init__(self, env: QuadcopterWaypointV2Env, window_name: str = "IsaacLab"):
...
@configclass
class QuadcopterWaypointV2EnvCfg(DirectRLEnvCfg):
    # env
    ...
    ui_window_class_type = QuadcopterWaypointV2EnvWindow
...
class QuadcopterWaypointV2Env(DirectRLEnv):
    cfg: QuadcopterWaypointV2EnvCfg

    def __init__(self, cfg: QuadcopterWaypointV2EnvCfg, render_mode: str | None = None, **kwargs):
