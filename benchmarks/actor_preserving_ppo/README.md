# Actor-Preserving PPO 正式 Benchmark
...
| checkpoint-selected BC+PPO | 91.67% | 8.33% | 0.30% |
| **actor-preserving PPO metric-selected** | **96.74%** | **3.17%** | **0.09%** |
| actor-preserving PPO reward-selected | 95.40% | 4.51% | 0.13% |
| actor-preserving PPO epoch200 last | 92.40% | 7.55% | 0.04% |

actor-preserving PPO metric-selected 为 2229/2304，Wilson 95% CI 为 [95.94%, 97.40%]。达到 90%：`True`；达到 92%：`True`。
