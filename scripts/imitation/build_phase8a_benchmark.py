"""Select P8A candidates and build the reproducible checkpoint-selection benchmark."""
...
def _finalize_mode(args: argparse.Namespace) -> None:
    ...
    summary = {
        "benchmark": "P8A periodic checkpoint selection and policy drift diagnosis",
        ...
        "answers": {
            ...
            "checkpoint_reselection_sufficient_for_positive_p8a": positive_case,
        ...
        "limitations": [
            ...
            "P8A does not retrain or modify the frozen P6C environment semantics.",
        ],
    }
    ...
    conclusion = (
        "Existing checkpoint reselection produced a positive P8A result." if positive_case else
        "The best existing periodic checkpoint still did not clearly exceed BC-only; checkpoint reselection alone is insufficient."
    )
    readme = f"""# P8A Checkpoint Selection and Policy Drift Diagnosis
...
def main() -> None:
    ...
    finalize.add_argument("--output_dir", default="benchmarks/phase8a_checkpoint_selection")
