"""Play rl_games agents for the quadcopter_waypoint external project.

The official Isaac Lab play script must launch Isaac Sim before importing task modules that depend on USD/pxr.
...
OFFICIAL_SCRIPT = ISAACLAB_ROOT / "scripts/reinforcement_learning/rl_games/play.py"
